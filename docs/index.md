...
The **API reference** is in the sidebar: [Providers](providers.md), [Backend](backend.md), [Primitives](primitives.md), and [Parameter Table](parameter_table.md). Example workflows (primitives, custom gates, calibrations, IQCC + Qiskit Experiments) are in the [examples](https://github.com/arthurostrauss/qiskit-qm-provider/tree/main/examples) folder on GitHub.
...
2. **QmSaasProvider** *(requires `pip install qiskit-qm-provider[qm_saas]`)*: Connects directly to the [QM SaaS platform](https://docs.quantum-machines.co/latest/docs/Guides/qm_saas_guide/).
...
Standalone examples for the Sampler and Estimator are in the [examples](https://github.com/arthurostrauss/qiskit-qm-provider/tree/main/examples) folder.
